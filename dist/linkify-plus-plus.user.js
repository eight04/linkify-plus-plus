...
var linkify = function(){
	...
	var urlUnicodeRE = /\b([-a-z*]+:\/\/)?(?:([\w:.+-]+)@)?([a-z0-9-.\u00b7-\u2a6d6]+\.[a-z0-9-कॉम佛山慈善集团在线한국点看คอมভারত八卦موقع公益司移动我爱你москвақзнлйт联通рбеקום时尚淡马锡гनेट삼성சிங்கபூர商标店城диюポイント新闻工行ك中文网信国國娱乐谷歌భారత్ලංකා购物ભારતभारतसंगठ餐厅络у香港诺基亚飞利浦台湾灣手表机الجزئرنیتبديھغسةه澳門닷컴政府شგე构组织健康ไทยф珠宝大拿みんなグールελ世界ਭਾਰਤ址넷コム游戏ö企业息صط广东இலைநதயாհայ加坡ف务]{1,24})\b(:\d+)?([/?#]\S*)?|\{\{(.+?)\}\}/ig,
