...
var linkify = function(){
	...
	var urlUnicodeRE = /(?:\b|_)([-a-z*]+:\/\/)?(?:([\w:.+-]+)@)?([a-z0-9-.\u00b7-\u2a6d6{STRIP_OUT}]+\.[a-z0-9-セール佛山慈善集团在线한국八卦موقعবাংল公司香格里拉网站移动我爱你москвақзтлинйрбгеファッションストア삼성சிங்கபூர商标城дю新闻家電中文信国國ලංකාクラウドભારતभारत店संगठन餐厅络у港食品飞利浦台湾灣手机الجزئرنیتبدسيةكث澳門닷컴شგე构健康ไทยфみんなελ世界書籍址넷コム天主教息嘉大酒صط广东இலைநதயாհայ加坡ف]{1,22})\b(:\d+)?([/?#]\S*)?|\{\{(.+?)\}\}/ig,
		urlRE =  /(?:\b|_)([-a-z*]+:\/\/)?(?:([\w:.+-]+)@)?([a-z0-9-.{STRIP_OUT}]+\.[a-z0-9-]{1,22})\b(:\d+)?([/?#][\w-.~!$&*+;=:@%/?#(),'\[\]]*)?|\{\{(.+?)\}\}/ig,
